...
export function Settings(){
  ...
  async function deleteExpenseCategory(){if(!deleteCategoryTarget)return;const used=(deleteCategoryTarget.transactionCount||0)+(deleteCategoryTarget.budgetCount||0)>0;const ok=await request(`/api/expense-categories/${deleteCategoryTarget.id}`,'DELETE',used?{replacementCategoryId}:{});if(ok){setDeleteCategoryTarget(null);setReplacementCategoryId('');await load()}}
